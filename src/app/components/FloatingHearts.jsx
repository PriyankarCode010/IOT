...
export default function FloatingHearts() {
  ...
  useEffect(() => {
    const colors = ["text-pink-500", "text-pink-400", "text-pink-300", "text-red-400", "text-purple-400", "text-purple-300"];
    ...
    <div className="fixed inset-0 pointer-events-none z-10">
      {hearts.map((heart) => (
        <motion.div
          ...
          animate={{ y: [0, -30, 0], x: [0, 10, -10, 0], scale: [1, 1.1, 1], opacity: [0.7, 1, 0.7] }}
